...
const checkNumericOperators = () => {
    ...
    //======WRITE YOUR CODE (PROMPT-3)======//
        ...
        console.log("sum of 5 and 2: ", ? )
        console.log("product of 5 and 2: ", ? )
        console.log("division of 5 divided by  2: ", ? )
        console.log("division of 5 divided by  2: ", ? )
        console.log("remainder of 5 divided by 2: ", ? )
        console.log(" 5 squared is: ", ? )
